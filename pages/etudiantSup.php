      ...
      <div class="row">
          <div class="col-md-8">
            <div class="panel panel-info">
                ...
                <form method="post" action="insertDemande.php" class="form">
                    ...
                    <div class="form-group">
                        <label>Vous êtes en quel école ?</label>
                        <input type="text" name="ecole" placeholder="Répondez ici ..." class="form-control" required='required'/>
                    </div>
                    <div class="form-group">
                        <label>Vous êtes en quelle année ?</label>
                        <select name="niveau" class="form-control" required='required'>
                            <option value='1'>1ère année</option>
                            <option value='2'>2ère année<</option>
                            <option value='3'>3ère année<</option>
                            <option value='4'>4ère année<</option>
                            <option value='5'>5ère année<</option>
                        </select>
                    </div>
                    <div class="form-group">
